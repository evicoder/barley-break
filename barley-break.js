let cell_empty = 'c15'; //Переменная с нынешней пустой клеткой
let mass = ['c0', 'c1', 'c2', 'c3', 'c4', 'c5', 'c6', 'c7', 'c8', 'c9', 'c10', 'c11', 'c12', 'c13', 'c14', 'c15']; //массив с клетками. Номер массива соответствует ячейке, а значение массива - то, какой кусок картинки там находится
...
function check_move(move) { //функция с проверкой, доступен ли шаг куда-либо
	let cempty = window.cell_empty.substr(1); //присваиваем ид клетки с пустой костяшкой в переменную
